...
public class Dogmonster : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        DogSound = Resources.Load<AudioClip>("dogGrowl");
        DogAtkSound = Resources.Load<AudioClip>("DogatkV2");
    ...
    void AttackP()
    {
            ...
            {timeFlip = 0;
                ...
                // หาทิศทางไปยังผู้เล่น
                    ...
                    direction.y = 0;
                    transform.Translate(direction * moveSpeed*3 * Time.deltaTime);
        ...
        IEnumerator AnimateAttack()
            {
                ...
                audioSrc.PlayOneShot(DogAtkSound);

                yield return new WaitForSeconds(0.3f); // รอเวลาอนิเมชัน 1 วินาที
    ...
    void spriteRendererFlip()
    {
        if (spriteRenderer.flipX == false)
        {
            footOffset = new Vector3(1 , footOffset.y , 0);
            floorOffset = Vector2.right;
            areaAttack = new Vector3(1 , areaAttack.y , 0);
